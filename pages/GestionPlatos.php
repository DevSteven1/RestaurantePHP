        ...
        <div class="p-4 sm:ml-64">
            <div class="min-w-[200px] p-4  border border-gray-200 rounded-lg dark:bg-white-800 mt-28 dark:border-gray-300 shadow-xl">
                ...
                <div class="grid grid-cols-12 mb-3">
                    <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Buscar</label>
                    <input type="text" id="small-input" class="block w-full col-span-12 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
