...
<body>
    ...
    //Conexion con la DB
    $colums = getColumsName("tb_usuarios");
    $data = getAllData("tb_usuarios");

    $JSON = file_get_contents('../data/JsonTrabajadores.json');
        ...
        <div class="min-w-[200px] p-4  border border-gray-200 rounded-lg  mt-[3%] shadow-xl">
            ...
            <div class="overflow-auto max-h-[400px]">
                <div class="grid grid-cols-12 mb-4">
                    <?php Tablas($columnas, $contenido, false , "tb_usuarios")  ?>
                </div>
            </div>
    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow animate__animated animate__fadeIn transform transition-all duration-1000 ease-linear">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-2 md:p-4 border-b rounded-t">
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-4">
                        <div class="col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Cedula</label>
                            <input type="text" name="NombrePlato" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Numero de Cedula" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nombre</label>
                            <input type="text" name="NombrePlato" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nombre del Trabajador" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Apellido</label>
                            <input type="text" name="NombrePlato" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Apellido del Trabajador" required="">
                        </div>
                        <div class="col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Rol</label>
                            <select id="category" name="Categoria" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-[100%] p-2.5" required>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow animate__animated animate__fadeIn transform transition-all duration-1000 ease-linear">
                ...
                <div class="flex items-center justify-between p-4 md:p-4 border-b rounded-t">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="restablecimiento-modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <form class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-12">
                        ...
                        <div class="col-span-5 mt-7">
                            <button type="submit" class="truncate text-center py-2.5 px-3 ms-1 text-sm w-full    font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-600  focus:outline-none focus:ring-blue-300">
                                Buscar
                            </button>
                        </div>
                    </div>
